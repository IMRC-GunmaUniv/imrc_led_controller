...
COLOR_VALUES = [
    ...
    {"color": "PURPLE", "value_r": 255, "value_g": 0, "value_b": 255},
    {"color": "YELLOW", "value_r": 255, "value_g": 255, "value_b": 0},
]
...
class LedController(Node):
    ...
    def led_cmd_callback(self, msg):
        ...
        ledData.led_color_red = int(ledData.led_color_red * brightness)
        ledData.led_color_green = int(ledData.led_color_green * brightness)
        ledData.led_color_blue = int(ledData.led_color_blue * brightness)

        if(msg.led_mode == "apply"):
            ledData.led_mode = 0
        elif(msg.led_mode == "blink"):
            ledData.led_mode = 1
        elif(msg.led_mode == "gblink"):
            ledData.led_mode = 2
